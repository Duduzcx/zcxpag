...
export const WhatsAppButton = () => {
  const openWhatsApp = () => {
    window.open(
      "https://wa.me/5511921572675?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20a%20criação%20de%20um%20site.",
      "_blank"
    );
  };
  ...
  return (
    ...
    >
  <SiWhatsapp className="md:w-9 md:h-9 w-6 h-6 text-white" />
    </button>
  );
};